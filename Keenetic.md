...
Компонент «Протокол IPv6» можно оставить включённым. Полноценная маршрутизация IPv6 через VPN пока не реализована, поэтому проверьте отсутствие утечек IPv6.
